            ...
            <div class="card-body">
                <div class="container-fluid">
                    <form action="" id="babysitter-form">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="" class="control-label">Occupied Status</label>
                                <select name="occupied_status" id="occupied_status" class="form-control form-control-border" required>
                                    <option value="not_occupied" <?= isset($occupied_status) && $occupied_status == "not_occupied" ? "selected" : "" ?>>not_occupied</option>
                                    <option value="occupied" <?= isset($ccupied_status) && $ccupied_status == "occupied" ? "selected" : "" ?>>occupied</option>
                                </select>
                            </div>
                        </div>
                    </form>
